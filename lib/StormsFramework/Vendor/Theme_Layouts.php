...
class Theme_Layouts extends Base\Runner
{
	 ...
	 * @return void
	 */
	public function theme_layouts_remove_post_type_support() {
	 ...
	 */
	public function theme_layouts_get_layouts() {
	 ...
	 */
	public function theme_layouts_get_args() {
	 ...
	 */
	public function theme_layouts_get_layout() {
	 ...
	 */
	public function theme_layouts_strings() {
	 ...
	 * @return string
	 */
	public function theme_layouts_get_string( $layout ) {
	 ...
	 */
	public function theme_layouts_get_meta_key() {
	 ...
	 */
	public function post_layouts_get_layout() {
		return $this->theme_layouts_get_layout();
	}
