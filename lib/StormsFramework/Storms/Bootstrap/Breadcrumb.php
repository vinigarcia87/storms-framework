 ...
 * @version   3.0.0
 *
 * StormsFramework\Storms\Bootstrap\NavWalker class
...
Use StormsFramework\Vendor;

class Breadcrumb extends Vendor\Breadcrumb_Trail {
	 ...
	 * This is a wrapper function for the Breadcrumb_Trail class, which should be used in theme templates.
	 *
	 * @access public
...
//
//		$new_title = $dom->createElement('span');
//		$new_title->appendChild($dom->createTextNode($node->nodeValue));
