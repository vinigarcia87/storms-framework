 ...
 * @version   3.0.0
 *
 * StormsFramework\Storms\WooCommerce\Functions class
	...
	*/
	...
	public static function storms_cart_link() {
		...
		<li class="<?php echo esc_attr( $class ); ?>">
			<a class="cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php _e( 'View your shopping cart', 'storms' ); ?>">
