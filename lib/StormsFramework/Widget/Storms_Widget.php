...
namespace StormsFramework\Widget;
 ...
 * @extends  WP_Widget
 */
abstract class Storms_Widget extends \WP_Widget {
	...
	public function update( $new_instance, $old_instance ) {
		...
		foreach ( $this->settings as $key => $setting ) {
			 ...
			 */
			$instance[ $key ] = apply_filters( 'storms_widget_settings_sanitize_option', $instance[ $key ], $new_instance, $key, $setting );
		}
	...
	public function form( $instance ) {
		...
		foreach ( $this->settings as $key => $setting ) {
			...
			switch ( $setting['type'] ) {
				...
				default:
					do_action( 'storms_widget_field_' . $setting['type'], $key, $value, $setting, $instance );
					break;
			}
		}
	}
	...
	protected function get_widget_id_for_cache( $widget_id, $scheme = '' ) {
		...
		return apply_filters( 'storms_cached_widget_id', $widget_id_for_cache );
	}
}
