	...
	var wc_ecfb_frontend = {
		...
		person_type_fields: function() {
			...
			if ( '1' === wcbcf_public_params.person_type ) {
				$( 'input[type=radio][name=billing_persontype]' ).on( 'change', function () {
					var current = $('input[name=billing_persontype]:checked').val();
